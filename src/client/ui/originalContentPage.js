					...
					<div className="whiskeyContent">
						...
						<div className="bigContentFlex">
							<div className="flex2">
								...
								<div className="originalText">The word 'whiskey' or 'whisky' comes from the Gaelic uisge beatha, meaning water of life. The difference in spelling is generally determined by regional custom. Scotland and Canada use 'whisky' while the US and Ireland go with 'whiskey'. There is no hard and fast rule governing this and distillers are free to spell it how they like.</div>
							...
							<div className="lastContent">
								...
								<div className="originalText wideBox">Tennessee whiskey is just like straight bourbon except that it's made in Tennessee and undergoes an extra charcoal filtration process known as the Lincoln County Process.</div>
